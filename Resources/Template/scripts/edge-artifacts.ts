 ...
 * public/.well-known/security.txt, public/.well-known/mta-sts.txt, and
 * public/.well-known/atproto-did. Runs at prebuild (after csp.ts). robots.txt
 * is stable and committed; the .well-known files are per-build/config-derived and
 * gitignored (security.txt generated only when SECURITY_TXT_MODE resolves to "generated" —
 ...
 * verification via the atproto HTTPS method).
 */
