...
- [ADR-0003 Cloudflare Pages](${CLAUDE_PLUGIN_ROOT}/docs/decisions/0003-cloudflare-pages-hosting.md) — gating runs as a Pages Function at the edge, no static HTML reaches an unauthorized visitor
