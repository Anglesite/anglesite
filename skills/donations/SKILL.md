...
- [ADR-0008 No third-party JS](${CLAUDE_PLUGIN_ROOT}/docs/decisions/0008-no-third-party-javascript.md) — All three providers below are plain external redirects. No third-party JavaScript is loaded on the site.
