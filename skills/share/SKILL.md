...
- [ADR-0008 No third-party JS](${CLAUDE_PLUGIN_ROOT}/docs/decisions/0008-no-third-party-javascript.md) — The Web Share API is a browser built-in. No AddThis, ShareThis, or social button libraries. Zero external requests.
