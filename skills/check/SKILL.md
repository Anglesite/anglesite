...
After the check, tell the owner: "This is the same kind of health check a good web developer would run regularly. Your site should get one of these at least once a month — just type `/anglesite:check` anytime."
