...
# Skill Registry (56 skills)

## User-facing

Invoked via `/anglesite:<name>` (31 skills):
...
| `inbox` | Browse, triage, and export form submissions from Keystatic instead of digging through email |
| `indieweb` | Deploy self-owned IndieAuth, Webmention, and Micropub endpoints on your domain |
...
| `pwa` | Make the site installable as a Progressive Web App with offline support |
...
| `share` | Add native sharing to pages and blog posts via the Web Share API |
