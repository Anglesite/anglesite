...
# Skill Registry (42 skills)

## User-facing

Invoked via `/anglesite:<name>` (18 skills):
...
| `design-import` | Import design tokens and page layouts from a Canva published site or Figma file to build your Astro site |
...
Called programmatically by other skills (24 skills):
