...
- **Food safety (FSMA)**: The FDA's Food Safety Modernization Act exempts most small farms selling direct to consumers, but farms selling to retailers or institutions may need a food safety plan. Not a website concern, but worth noting during `/anglesite:setup-customers` if the farm sells wholesale.
