...
Check if `.site-config` exists with `SITE_NAME`. If not, tell the owner: "It looks like this is a fresh start. Type `/start` to set up your business and website from scratch — it includes the tool installation."
