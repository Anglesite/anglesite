...
Run `/check` for the full health check (build, accessibility, privacy, security, SEO, performance, iCloud). The deploy command also runs mandatory privacy and security gates.
