...
How to build, manage, and display reviews and testimonials. Reference for the webmaster agent — applied during `/start`, `/design-interview`, content planning, and ongoing maintenance. Not user-facing documentation.
...
During `/start` or `/design-interview`, ask: "Where have your customers left reviews? Where would you like them to?" Focus on 1–2 platforms — don't spread thin.
...
During `/start`, if the owner has a Google Business Profile, find their Place ID and create a direct review link. Save it in `.site-config`:
```
...
During `/design-interview`, ask: "Do you have positive reviews or customer testimonials you'd like to show on the website?"
...
During monthly `/check`, ask the owner:
