...
Setup guidance and integration tips for the SaaS platforms recommended across multiple business types. Reference for the webmaster agent — read the relevant platform file when the owner chooses a platform during `/start` or `/design-interview`. Not user-facing documentation.
